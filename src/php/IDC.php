<?php
    ...
    if(isset($_REQUEST['dept']) && isset($_REQUEST['year']) && isset($_REQUEST['div'])){
        ...
        $sql = "SELECT subjid, fid, room_no, weekday, start_time, end_time FROM idcLectureSlot WHERE idcLectureSlot.dept = '".$dept."' AND idcLectureSlot.year_of_study = '".$year."' AND idcLectureSlot.division = '".$division."'";
